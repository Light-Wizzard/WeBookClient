 ...
 */
ConsoleAppender::ConsoleAppender() : AbstractStringAppender(), myIgnoreEnvPattern(false)
{
...
QString ConsoleAppender::format() const
{
    ...
    return (myIgnoreEnvPattern || envPattern.isEmpty()) ? AbstractStringAppender::format() : (envPattern + "\n");
} // end format
/******************************************************************************
...
{
    myIgnoreEnvPattern = ignore;
} // end ignoreEnvironmentPattern
/******************************************************************************
** append                                                                     *
*******************************************************************************/
 ...
 */
void ConsoleAppender::append(const QDateTime& timeStamp, Logger::LogLevel logLevel, const char* file, int line, const char* function, const QString& category, const QString& message)
{
