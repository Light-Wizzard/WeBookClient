...
class CUTELOGGERSHARED_EXPORT RollingFileAppender : public FileAppender
{
     ...
     */
        ...
        RollingFileAppender(const QString &getFileName = QString());

        DatePattern getDatePattern() const;
        void setDatePattern(DatePattern getDatePattern);
        void setDatePattern(const QString &getDatePattern);

        QString getDatePatternString() const;

        void setLogFilesLimit(int limit);
        int getLogFilesLimit() const;
    ...
    private:
        ...
        void removeOldFiles();
        void setDatePatternString(const QString &getDatePatternString);

        QString         myDatePatternString;
        DatePattern     myFrequency;

        QDateTime       myRollOverTime;
        QString         myRollOverSuffix;
        int             myLogFilesLimit;
        mutable QMutex  myRollingMutex;
