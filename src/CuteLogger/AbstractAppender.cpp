...
AbstractAppender::AbstractAppender() : myDetailsLevel(Logger::Debug)
{

} // end AbstractAppender
/******************************************************************************
** AbstractAppender Deconstructor                                             *
*******************************************************************************/
...
{
    QMutexLocker locker(&myDetailsLevelMutex);
    return myDetailsLevel;
} // end detailsLevel
/******************************************************************************
** setDetailsLevel                                                            *
*******************************************************************************/
 ...
 * \sa detailsLevel()
 */
void AbstractAppender::write(const QDateTime& timeStamp, Logger::LogLevel logLevel, const char* file, int line, const char* function, const QString& category, const QString& message)
{
    if (logLevel >= detailsLevel())
    {
        QMutexLocker locker(&myWriteMutex);
