...
namespace QLogger
{
    ...
    class QLoggerWriter : public QThread
    {
        ...
        public:
            /*!
             * @brief Constructor that gets the complete path and filename to create the file.
             * It also configures the level of this file to filter the logs depending on the level.
