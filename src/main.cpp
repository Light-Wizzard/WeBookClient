...
int main(int argc, char *argv[])
{
    ...
    if (thatInit.isEmpty())      thatInit         = qLoggerCommon->getIniFileName();
    ...
    if (thatFilePath.isEmpty())  thatFilePath     = qLoggerCommon->getFilelPath();
    ...
    qLoggerCommon->setIniFileName(thatInit);
    ...
    qLoggerCommon->setFilePath(thatFilePath);
