...
class MainWindow : public QMainWindow
{
    ...
    public:
        ...
        enum MainTabs
        {
            TabSettings     =0, //!< \c TabSettings       \brief TabSettings .
            TabConnectionMan=1, //!< \c TabConnectionMan  \brief TabConnectionMan .
            TabWeBookMan    =2, //!< \c TabWeBookMan      \brief TabWeBookMan .
            TabTOC          =3, //!< \c TabTOC            \brief TabTOC .
            TabEditor       =4, //!< \c TabEditor         \brief TabEditor .
            TabContacts     =5, //!< \c TabContacts       \brief TabContacts .
            TabFileMan      =6, //!< \c TabFileMan        \brief TabFileMan .
            TabCalendarMan  =7, //!< \c TabCalendarMan    \brief TabCalendarMan .
            TabCalculator   =8  //!< \c TabCalculator     \brief TabCalculator .
        }; // end enum MainTabs
        ...
        //
        const QString constDefaultTOC            = "Home\tHome Page\n"; //!< \c constDefaultTOC \brief Default TOC Content
        const QString constDefaultWeBook         = "WeBook\n";          //!< \c constDefaultWeBook \brief Default WeBook Content
    ...
    signals:
        ...
        void handleEventAction(int eventValue);                                             //!< Events that change QSettings trigger
